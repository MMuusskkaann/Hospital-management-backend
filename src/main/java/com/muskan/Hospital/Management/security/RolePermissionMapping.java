...
import static com.muskan.Hospital.Management.model.RoleType.*;
...
public class RolePermissionMapping {
    ...
    public static Set<SimpleGrantedAuthority> getAuthoritiesForRole(com.muskan.Hospital.Management.entity.type.RoleType role) {
